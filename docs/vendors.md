* SDKMAN!
  * 👀empowers SDK Vendors / publish their candidate releases | SDKMAN! platform👀
  * 's secure API
    * uses
      * 👀manage ALL aspects (release new, set default, broadcast a release message) of a release | SDKMAN!👀
